function validateAppointment() {
  try {
      let name1 = document.forms.appointments.name1.value.trim();
      let hospitalrec = document.forms.appointments.hospitalrec.value.trim();
      let phone = document.forms.appointments.phone.value.trim();
      ...
      let reason = document.forms.appointments.reason.value.trim();
      ...
      console.error(err);
      return false; // Error occurred during validatio
  }
}